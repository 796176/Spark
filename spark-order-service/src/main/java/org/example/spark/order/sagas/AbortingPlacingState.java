...
public class AbortingPlacingState implements SagaState {
	...
	public AbortingPlacingState(@Nonnull OrderServiceProxy orderService, long sagaId) {
	...
	public boolean initialize(@Nonnull Saga saga) throws Exception {
		return orderService.abortPlacing(this, saga, saga.getOrderId(), correlationId);
	}
