...
public class ConfirmingPlacingState implements SagaState {
	...
	public ConfirmingPlacingState(@Nonnull OrderServiceProxy orderService, long sagaId) {
	...
	public boolean initialize(@Nonnull Saga saga) throws Exception {
		return orderService.confirmPlacing(this, saga, saga.getOrderId(), correlationId);
	}
