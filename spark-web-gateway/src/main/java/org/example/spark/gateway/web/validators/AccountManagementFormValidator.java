...
@Component
public class AccountManagementFormValidator implements Validator {
	@Override
	...
	public ValidationResult validate(@Nonnull Object o) {
		AccountManagementForm accountManagementForm = (AccountManagementForm) o;
		String validationResult = FormValidators.validateAccountManagementForm(accountManagementForm);
