...
@Component
public class CreatingAccountFormValidator implements Validator {
	@Override
	...
	public ValidationResult validate(@Nonnull Object o) {
		CreatingAccountForm creatingAccountForm = (CreatingAccountForm) o;
		String validationResult = FormValidators.validateCreatingAccountForm(creatingAccountForm);
