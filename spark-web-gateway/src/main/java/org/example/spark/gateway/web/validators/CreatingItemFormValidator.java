...
@Component
public class CreatingItemFormValidator implements Validator {
	@Override
	...
	public ValidationResult validate(@Nonnull Object o) {
		CreatingItemForm creatingItemForm = (CreatingItemForm) o;
		String validationResult = FormValidators.validateCreatingItemForm(creatingItemForm);
