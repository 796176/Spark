...
public class GeneralRequestProcessor {
	...
	public GeneralRequestProcessor(UploadedFileDataAccess uploadedFileDataAccess) {
		this.uploadedFileDataAccess = uploadedFileDataAccess;
	}

	public UploadedFileDataAccess.Blob getUploadedFile(@Nonnull String fileName) {
		return uploadedFileDataAccess.getBlob(fileName);
	}
}
