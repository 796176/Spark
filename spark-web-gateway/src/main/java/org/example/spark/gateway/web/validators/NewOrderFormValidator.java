...
@Component
public class NewOrderFormValidator implements Validator {
	...
	public ValidationResult validate(@Nonnull Object o) {
		NewOrderForm newOrderForm = (NewOrderForm) o;
		String validationResult = FormValidators.validateNewOrderForm(newOrderForm);
