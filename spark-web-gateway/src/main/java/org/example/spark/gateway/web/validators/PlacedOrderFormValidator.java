...
@Component
public class PlacedOrderFormValidator implements Validator {
	@Override
	...
	public ValidationResult validate(@Nonnull Object o) {
		PlacedOrderForm placedOrderForm = (PlacedOrderForm) o;
		String validationResult = FormValidators.validatePlacedOrderForm(placedOrderForm);
