...
public interface UserOrderServiceProxy {

	void getOrders(@Nonnull Account account, @Nonnull Consumer<RemoteCallResult> callResultConsumer) throws Exception;
	...
	void cancelOrder(
		...
		@Nonnull Consumer<RemoteCallResult> remoteCallResultConsumer
	) throws Exception;
